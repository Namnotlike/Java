 ...
 * @author TTC
 */
@WebServlet(name = "EditNCC", urlPatterns = {"/admin/editNCC"})
public class EditNCC extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        NhaCungCap ncc = nccDao.details(request.getParameter("mancc"));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (back) {
            request.setAttribute("ncc", nccDao.details(mancc));
            request.getRequestDispatcher("/view/admin/nhacungcap/edit.jsp").forward(request, response);
        }
        else{
